<!DOCTYPE html>
    ...
    <body id="bg">
        ...
        <button onclick="location.href='admin.php'" id="HomeButton" class="button buttonEffect" >Home</button>
            <form action="empdetadd.php" method="POST" >            
                <div id="table" class="tabContent">
                    ...
                    <tr >
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="three_column"></td>
                        </tr>
                        ...
                        <tr>
                            <td>Contact</td>                            
                            <td><input type="number" name="eight_column"></td>
                        </tr>
                    </table>
                    <div id="ip_id" align="center" style="margin-top: 80px;" >
                        <div class="container">
                            <div class="center">
                                <button name="Update" type="submit" onclick="window.alert('Addition successful')" id="center" class="button buttonEffect" >ADD</button>
                            </div>
                        </div>
                    </div>
                </div>
